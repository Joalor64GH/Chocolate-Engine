	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'cocoa' | 'eggnog':
			{
				...
				var bg:FlxSprite = new FlxSprite(-1000, -500).loadGraphic(Paths.image('mall/bgWalls'));
				...
				upperBoppers.frames = Paths.getSparrowAtlas('mall/upperBop');
				...
				var bgEscalator:FlxSprite = new FlxSprite(-1100, -600).loadGraphic(Paths.image('mall/bgEscalator'));
				...
				var tree:FlxSprite = new FlxSprite(370, -250).loadGraphic(Paths.image('mall/christmasTree'));
				tree.antialiasing = true;
				tree.scrollFactor.set(0.40, 0.40);
				add(tree);

				bottomBoppers = new FlxSprite(-300, 140);
				bottomBoppers.frames = Paths.getSparrowAtlas('mall/bottomBop');
				...
				var fgSnow:FlxSprite = new FlxSprite(-600, 700).loadGraphic(Paths.image('mall/fgSnow'));
				fgSnow.active = false;
				fgSnow.antialiasing = true;
				add(fgSnow);

				santa = new FlxSprite(-840, 150);
				santa.frames = Paths.getSparrowAtlas('mall/santa');
			...
			{
				curStage = 'mallEvil';
				var bg:FlxSprite = new FlxSprite(-400, -500).loadGraphic(Paths.image('mallEvil/evilBG'));
				bg.antialiasing = true;
				bg.scrollFactor.set(0.2, 0.2);
				bg.active = false;
				bg.setGraphicSize(Std.int(bg.width * 0.8));
				...
				var evilTree:FlxSprite = new FlxSprite(300, -300).loadGraphic(Paths.image('mallEvil/evilTree'));
				evilTree.antialiasing = true;
				evilTree.scrollFactor.set(0.2, 0.2);
				add(evilTree);

				var evilSnow:FlxSprite = new FlxSprite(-200, 700).loadGraphic(Paths.image("mallEvil/evilSnow"));
			...
			case 'senpai' | 'roses':
			{
				...
				var bgSky = new FlxSprite().loadGraphic(Paths.image('school/weebSky'));
				bgSky.scrollFactor.set(0.1, 0.1);
				add(bgSky);

				var repositionShit = -200;

				var bgSchool:FlxSprite = new FlxSprite(repositionShit, 0).loadGraphic(Paths.image('school/weebSchool'));
				bgSchool.scrollFactor.set(0.6, 0.90);
				add(bgSchool);

				var bgStreet:FlxSprite = new FlxSprite(repositionShit).loadGraphic(Paths.image('school/weebStreet'));
				bgStreet.scrollFactor.set(0.95, 0.95);
				add(bgStreet);

				var fgTrees:FlxSprite = new FlxSprite(repositionShit + 170, 130).loadGraphic(Paths.image('school/weebTreesBack'));
				fgTrees.scrollFactor.set(0.9, 0.9);
				add(fgTrees);

				var bgTrees:FlxSprite = new FlxSprite(repositionShit - 380, -800);
				var treetex = Paths.getPackerAtlas('school/weebTrees');
				...
				treeLeaves.frames = Paths.getSparrowAtlas('school/petals');
			...
			case 'thorns':
			{
				...
				bg.frames = Paths.getSparrowAtlas('schoolEvil/animatedEvilSchool');
